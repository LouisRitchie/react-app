  ...
  render() {
    return (
      <div className="hireme">
        ...
        <p className='sellParagraph'>
          Teamwork and communication are what make or break projects, so I provide you with details before you need them. I've worked for fast-paced startups in Victoria and in San Fransisco, where it's imperative that the full scope of features is made clear at the beginning of development.
        </p>
